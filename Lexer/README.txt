...
4) Use "python3 parser.py <input_file>" to run the lexer for the <input_file>
...
2) Type "make", "make run" or "make tests" to run our Lexer with "test.txt" as default input file
